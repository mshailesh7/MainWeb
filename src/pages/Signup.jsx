              ...
              <div className="space-y-4">
                ...
                <div className="relative flex items-center">
                  ...
                  <div className="absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer text-gray-500">
                    {showPassword ? (
                      <IoEyeSharp className="text-xl" onClick={() => setShowPassword(!showPassword)} />
                    ) : (
                ...
                <div className="relative flex items-center">
                  ...
                  <div className="absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer text-gray-500">
                    {showConfirmPassword ? (
                      <IoEyeSharp className="text-xl" onClick={() => setShowConfirmPassword(!showConfirmPassword)} />
                    ) : (
                      <FaEyeSlash className="text-xl" onClick={() => setShowConfirmPassword(!showConfirmPassword)} />
                    )}
                  </div>
                </div>
              </div>

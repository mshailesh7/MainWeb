...
const BackgroundSection = ({ children }) => (
  <div className="h-screen" style={{ maxHeight: '60vh' }}>
    <div className="absolute inset-0 bg-black opacity-90 bg-cover bg-center" style={{ backgroundImage: `url(${MainHomeLanding})` }} />
...
const PhotoGallery = () => (
  <div className="bg-white py-8">
    <div className="container mx-auto">
      <h2 className="text-5xl mb-6 text-center text-black">Photo Gallery</h2>
...
const Footer = () => (
  <footer className="bg-gray-400 py-12">
    <div className="container mx-auto text-center">
      <h2 className="text-4xl font-bold text-white underline">Get Latest Updates</h2>
      <form className="flex flex-col items-center mt-8">
        <div className="flex items-center">
          <label htmlFor="email" className="text-xl mr-4 font-bold text-white">Subscribe to Newsletter:</label>
          <input type="email" id="email" placeholder="Enter email address" className="rounded-lg px-6" aria-label="Email Address" />
        </div>
      </form>
    </div>
  </footer>
